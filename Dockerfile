...
RUN apt-get update \
    ...
    && wget --quiet https://github.com/BtbN/FFmpeg-Builds/releases/download/latest/ffmpeg-master-latest-linux64-gpl.tar.xz -O /tmp/ffmpeg-master-latest-linux64-gpl.tar.xz && tar xvaf /tmp/ffmpeg-master-latest-linux64-gpl.tar.xz -C /tmp/ && mv /tmp/ffmpeg-master-latest-linux64-gpl/bin/* /usr/local/bin/ \
