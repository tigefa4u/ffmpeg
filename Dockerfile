...
RUN apt-get update \
    ...
    && cd /tmp && aria2c https://github.com/BtbN/FFmpeg-Builds/releases/download/latest/ffmpeg-master-latest-linux64-gpl.tar.xz && tar xvaf /tmp/ffmpeg-master-latest-linux64-gpl.tar.xz && mv /tmp/ffmpeg-master-latest-linux64-gpl/bin/* /usr/local/bin/ \
