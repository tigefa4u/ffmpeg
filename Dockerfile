...
RUN apt-get update \
    ...
    && apt-get install -yqq lsb-release apt-transport-https ca-certificates software-properties-common bash bash-completion wget curl netcat aria2 whois figlet telnet net-tools nmap tree lshw htop p7zip p7zip-full zip unzip \
    ...
    && apt-get install -yqq nodejs git git-lfs \
