...
RUN apt-get update \
    ...
    && apt-get install -yqq lsb-release apt-transport-https ca-certificates software-properties-common bash bash-completion wget curl aria2 tar rar unrar p7zip p7zip-full zip unzip \
